                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="space-y-3 bg-gray-50 p-4 rounded-xl border border-gray-100">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div><label className="block text-[10px] font-bold text-gray-500 uppercase mb-1">Director de Plantel</label><input type="text" disabled={estaCerrado} className="w-full p-2 border rounded-lg text-xs disabled:bg-gray-100" value={esc.coord_centro_votacion || ''} onChange={e => handleInputChange(esc.id, 'coord_centro_votacion', e.target.value)} /></div>
                        <div><label className="block text-[10px] font-bold text-gray-500 uppercase mb-1">Representante CNE</label><input type="text" disabled={estaCerrado} className="w-full p-2 border rounded-lg text-xs disabled:bg-gray-100" value={esc.presidenta_centro || ''} onChange={e => handleInputChange(esc.id, 'presidenta_centro', e.target.value)} /></div>
                        <div><label className="block text-[10px] font-bold text-gray-500 uppercase mb-1">Representante Comunal</label><input type="text" disabled={estaCerrado} className="w-full p-2 border rounded-lg text-xs disabled:bg-gray-100" value={esc.presidenta_mesa || ''} onChange={e => handleInputChange(esc.id, 'presidenta_mesa', e.target.value)} /></div>
                        <div><label className="block text-[10px] font-bold text-gray-500 uppercase mb-1">Secretario CNE</label><input type="text" disabled={estaCerrado} className="w-full p-2 border rounded-lg text-xs disabled:bg-gray-100" value={esc.secretaria || ''} onChange={e => handleInputChange(esc.id, 'secretaria', e.target.value)} /></div>
                      </div>
                    </div>
